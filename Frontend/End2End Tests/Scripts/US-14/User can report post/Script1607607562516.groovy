...
WebUI.click(findTestObject('Object Repository/Page_React App/span_Open Menu'))

WebUI.click(findTestObject('Object Repository/Page_React App/li_Report'))

WebUI.click(findTestObject('Object Repository/Page_React App/span_Yes'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_React App/div_Thank you for your report'), 0)
